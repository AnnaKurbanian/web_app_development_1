...
object = AbcModel.objects.get(pk=11)
AbcModel.objects.filter(task__contains='Явл')
AbcModel.objects.filter(task__icontains='Явл')
AbcModel.objects.filter(task__contains='Явл').count()
connection.queries
AbcModel.objects.filter(task__icontains='яет', id__gte=17)
AbcModel.objects.filter(task__icontains='яет', id__gte=17).count()
cur_objects = AbcModel.objects.filter(task__icontains='яет', id__gte=15)
